<x-container class="mb-16 text-sm text-center space-y-8 px-8">
    <div>
        Hit me up on
        <a href="https://twitter.com/LiamHammett" class="relative group font-semibold text-orange-700 hover:text-orange-500">
            ...
            <span class="hidden group-hover:inline-block absolute text-center bg-white text-red-300 p-2 rounded shadow-lg top-4 -left-16 -right-16">I guess it's called <span class="text-red-500 font-bold">X</span> now</span>
        </a>
        /
        ...
        <a href="https://www.linkedin.com/in/liam-hammett-79691137/" class="relative group font-semibold text-orange-700 hover:text-orange-500">
            <span class="inline-block group-hover:hidden">LinkedIn</span>
            <span class="hidden group-hover:inline-block"><s>LinkedIn</s></span>
            <span class="hidden group-hover:inline-block absolute text-center bg-white text-red-300 p-2 rounded shadow-lg top-4 -left-16 -right-16">If you're a corporate kind of person</span>
        </a>
        /
